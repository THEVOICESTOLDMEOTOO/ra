warn("Script: ⚠️")
warn("Script: ⚠️A critical error has occured [UI attempted to bind with the parasizing nil instance]⚠️")
warn("Script: while end was called it failed to index with C:\Users\LocalUser\Game.ByteAnalysis")
warn("Script: Debug process indicated that their was an error when calling Game.ByteAnalysis")
warn("Script: ⚠️")
